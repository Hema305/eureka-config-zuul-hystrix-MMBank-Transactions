...
public class TransactionController {
	...
	public ResponseEntity<Transaction> deposit(@RequestBody Transaction transaction) {
		ResponseEntity<Double> entity=restTemplate.getForEntity("http://accounts/bankaccounts/" + transaction.getAccountNumber() + "/balance",
				Double.class);
		...
		restTemplate.put("http://accounts/bankaccounts/"+transaction.getAccountNumber()+"?currentBalance="+updateBalance, null);
